...
## Disclaimer
This assessment was performed on a deliberately vulnerable application for educational purposes only. No active exploitation was conducted. All testing complied with the assigned scope.
```

  
   - Encodage : UTF-8  
   - Enregistrer sur ton bureau (par exemple).  
6. **Téléverse** ce fichier dans ton dépôt GitHub (`FUTURE_CS_01`) comme expliqué précédemment.
